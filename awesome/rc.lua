...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "p", "t", "q", "k" }, s, awful.layout.layouts[1])
...
bling.widget.window_switcher.enable {
    ...
    cycleClientsByIdx = function(c) 
        require("naughty").notify({title=c}) 
        awful.client.focus.byidx(c) end,               -- The function to cycle the clients
